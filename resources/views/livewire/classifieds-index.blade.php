...
<div class="bg-gray-50 min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @endphp
        <x-announce-cta
            title="Quer anunciar nos classificados?"
            description="Crie sua conta e publique equipamentos, produtos e oportunidades B2B para o mercado pet."
            :href="$isSupplier ? route('supplier.classifieds') : route('register.select')"
            :label="$isSupplier ? 'Publicar anúncio' : 'Criar conta e anunciar'"
        />
