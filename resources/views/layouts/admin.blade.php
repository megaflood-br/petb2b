        ...
        <aside class="w-72 bg-gray-950 text-white flex flex-col shadow-2xl border-r border-gray-900 shrink-0">
            ...
            <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.users') }}"
                   class="flex items-center gap-3 p-4 rounded-2xl text-xs font-black uppercase tracking-wider transition {{ request()->routeIs('admin.users') ? 'bg-brand-500 text-white shadow-lg shadow-brand-500/20' : 'text-gray-400 hover:bg-gray-900 hover:text-white' }}">
                ...
                <a href="{{ route('admin.settings') }}"
                   class="flex items-center justify-between gap-3 p-4 rounded-2xl text-xs font-black uppercase tracking-wider transition {{ request()->routeIs('admin.settings') ? 'bg-brand-500 text-white shadow-lg shadow-brand-500/20' : 'text-gray-400 hover:bg-gray-900 hover:text-white' }}">
                    ...
                    @if(\App\Support\Settings::maintenanceEnabled())
                        <span class="bg-amber-400 text-amber-950 text-[8px] font-black px-2 py-0.5 rounded-full tracking-wider">Manutenção</span>
                    @endif
                </a>
